        ...
        <div className="flex flex-wrap mx-20  items-center justify-center mt-20 mb-96">
            {
                data.slice(0 , 1).map((movie) => {
                    return(
                        <div className=" flex items-center justify-center h-52 w-96 overflow-hidden p-5 bg-secondry gap-10 rounded-xl py-28 px-10">
                            <img src={movie.thumbnail} className=" object-cover max-w-48 max-h-48 rounded-xl"/>
                            <div className="">
                                <h1 className=' text-2xl text-white font-bold mb-5'>{movie.title}</h1>
                                {/* ---------------Ratings------------ */}
                                <div className="flex gap-5 items-center my-1">
                                    <div>
                                        <FaImdb className=" text-imdb"/>
                                        <h1 className=" font-bold text-white">8/10</h1>
                                    </div>
                                    <div>
                                        <SiRottentomatoes className=" text-rose-600"/>
                                ...
                                <div className=" flex items-center justify-center gap mt-3 gap-3">
                                    <button className="flex items-center justify-center bg-purple text-white text-xs px-2 py-2  rounded-tl-md rounded-br-md rounded-tr-xl rounded-bl-xl hover:bg-black hover:text-white transition-all duration-300"><AiOutlineInfoCircle className="mx-2"/>Info</button>
