        ...
        <div className='w-[100vw] mx-auto flex justify-center items-center h-[100vh] bg-secondry text-white'>
            <div className='flex '>
                ...
                <div className=' flex items-center flex-col bg-primary p-8 h-[90vh]'>
                    ...
                    <div className=' flex flex-col justify-center items-center border-[1px] border-opacity-30 rounded-xl py-7 px-9'>
                        ...
                        <div  className=' flex flex-col items-center justify-center w-[100%]'>
                            ...
                            <input type="email"  className='mb-4 w-[100%] self-start text-black rounded-md px-3 py-1 outline-none border-[1px] border-purple font-medium' placeholder='Enter Email'/>
                            <label htmlFor="password" className=' text-xs self-start mb-2 font-semibold'>Password</label>
                            <input type="password"  className=' w-[100%] self-start text-black rounded-md px-3 py-1 outline-none border-[1px] border-purple font-medium' placeholder='Enter Password'/>
