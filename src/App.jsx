...
}, [searchWord]); // Add searchWord as a dependency
      ...
      <div className='h-full bg-dark_background flex overflow-x-hidden'>
        ...
        <div className='flex flex-col'>
          ...
          <div className='h-[9vh] w-[85vw] ml-[15vw] bg-navbar border border-search flex items-center justify-center gap-5 sticky top-0'>
              <div className=" w-[40vw]"><input type="text" placeholder="Search for Movies , Shows..." className=" bg-search text-white w-[35vw] focus:w-[40vw] pr-5 pl-5 py-2 rounded-full transition-all duration-100" onChange={(e) => setSearchWord(e.target.value)} /></div>
