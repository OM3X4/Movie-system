...
function MovieCard({movie , w , h}) {

    return (
    <>
        <Link to={`/movie/?name=${movie.title}`}>
            <div className={`relative flex items-center justify-center h-${h} w-${w} overflow-hidden p-5 bg-secondry rounded-xl  hover:scale-125 hover:delay-[1000ms] hover:bg-purple transition-all group m-5 hover:z-50 cursor-pointer`}>
